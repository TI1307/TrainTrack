...
export default function SearchResultsScreen({
  from, to, fromStationId, toStationId, ticketClass, onBack,
}: SearchResultParam) {
  ...
  return (
    <View style={styles.container}>
      {/* No MapView on web — react-native-maps has no web support at all */}
      <View style={[styles.map, styles.webMapFallback]}>
        <Ionicons name="map-outline" size={28} color="#B0BEC5" />
        <Text style={styles.webMapFallbackText}>
          خريطة التتبع المباشر متاحة على تطبيق الجوال فقط حالياً
        </Text>
      </View>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  map: { flex: 1 },
  webMapFallback: { backgroundColor: "#EDF1F5", justifyContent: "center", alignItems: "center", gap: 10 },
  webMapFallbackText: { color: "#78889B", fontSize: 13, textAlign: "center", paddingHorizontal: 30 },
